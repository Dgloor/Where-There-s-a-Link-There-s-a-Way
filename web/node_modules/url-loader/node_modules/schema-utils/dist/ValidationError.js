  ...
  formatValidationError(error) {
    ...
    switch (error.keyword) {
      ...
      case 'exclusiveMaximum':
        return `${dataPath} should be ${error.params.comparison} ${error.params.limit}${getSchemaNonTypes(error.parentSchema)}.${this.getSchemaPartDescription(error.parentSchema)}`;
      ...
      case 'minLength':
        {
          ...
          return `${dataPath} should not be shorter than ${error.params.limit} characters${getSchemaNonTypes(error.parentSchema)}.${this.getSchemaPartDescription(error.parentSchema)}`;
        }
      ...
      case 'maxLength':
        return `${dataPath} should not be longer than ${error.params.limit} characters${getSchemaNonTypes(error.parentSchema)}.${this.getSchemaPartDescription(error.parentSchema)}`;
